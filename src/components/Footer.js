...
const Footer = () => {
  ...
  return (
    <footer className='flex flex-col text-white   bg-primary border-t border-slate-200'>
    <div className='flex max-md:flex-col flex-wrap justify-between gap-5 sm:px-16 px-6 py-10'>
      <div className='flex flex-col justify-start items-start gap-3'>
        
      <Link href="/"><h3 className='text-white text-2xl font-bold tracking-widest'>iNotebook</h3></Link> 
    ...
    <div className='flex justify-between items-center flex-wrap mt-10 border-t  sm:px-16 px-6 py-10'>
      <p>@2024 piszza. All rights reserved</p>
